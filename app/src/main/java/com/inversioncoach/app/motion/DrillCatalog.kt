...
object DrillCatalog {
    ...
    private val drills = listOf(
        ...
        def(DrillType.HANDSTAND_PUSH_UP, "Free Standing Handstand Push-Up", "handstand push", DrillLevel.INTERMEDIATE, listOf("none"), listOf("neutral", "start", "mid_eccentric", "bottom", "mid_concentric", "top"), listOf("line_break", "depth_short", "lockout_missing"), listOf("Stay stacked", "Touch depth target", "Finish fully"), RepMode.REP_BASED, holdSpec("free_standing_hspu", inverted = true)),
        def(DrillType.WALL_HANDSTAND_PUSH_UP, "Wall Assisted Handstand Push-Up", "handstand push", DrillLevel.INTERMEDIATE, listOf("wall"), listOf("neutral", "start", "mid_eccentric", "bottom", "mid_concentric", "top"), listOf("wall_dump", "descent_fast", "elbow_flare"), listOf("Lower with control", "Keep line against wall", "Press to stacked top"), RepMode.REP_BASED, holdSpec("wall_assisted_hspu", inverted = true)),
    )
